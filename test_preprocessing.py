...
try:
    ...
    print(f"   - Mean: {img_preprocessed.numpy().mean():.4f}")
    print(f"   - Std: {img_preprocessed.numpy().std():.4f}")
    
    # Test 2: Using ImageDataGenerator (what training used)
    print(f"\n🔧 Test 2: ImageDataGenerator Preprocessing")
